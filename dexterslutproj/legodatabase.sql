...
--
-- Värd: 127.0.0.1
-- Tid vid skapande: 22 maj 2023 kl 13:24
...
INSERT INTO `comments` (`username`, `commentID`, `comment`, `date`, `replyTo`) VALUES
('lasse', 6, 'hej', '2023-03-31 09:31:05', NULL),
('lasse', 7, 'Detta är en kommentar', '2023-03-31 09:46:41', NULL),
('lasse', 8, 'AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA', '2023-03-31 09:47:14', NULL),
('lasse', 9, '\"Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.', '2023-03-31 09:50:57', NULL),
('lasse', 10, 'Detta är också en kommentar', '2023-03-31 09:51:19', NULL),
('lasse', 11, 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Habitant morbi tristique senectus et netus et. Elementum pulvinar etiam non quam lacus suspendisse faucibus interdum posuere. Ornare arcu dui vivamus arcu felis bibendum ut tristique. Quis enim lobortis scelerisque fermentum. Et molestie ac feugiat sed lectus vestibulum mattis. Volutpat ac tincidunt vitae semper quis. Laoreet sit amet cursus sit amet dictum sit amet. Eget nullam non nisi est sit amet. Lectus arcu bibendum at varius vel pharetra. Sodales ut eu sem integer vitae. Volutpat est velit egestas dui id ornare.', '2023-03-31 09:52:54', NULL),
('lasse', 12, 'Semper auctor neque vitae tempus quam pellentesque. Mauris pharetra et ultrices neque ornare aenean. At erat pellentesque adipiscing commodo. Amet consectetur adipiscing elit pellentesque habitant morbi. Vestibulum lectus mauris ultrices eros in cursus turpis massa tincidunt. Arcu dictum varius duis at. Viverra adipiscing at in tellus integer feugiat. Volutpat maecenas volutpat blandit aliquam etiam erat. Egestas tellus rutrum tellus pellentesque eu tincidunt tortor aliquam nulla. Aliquam ut porttitor leo a diam sollicitudin tempor. Egestas pretium aenean pharetra magna ac placerat vestibulum lectus. Risus nec feugiat in fermentum posuere urna.', '2023-03-31 09:53:20', NULL),
('lasse', 13, 'Det är fredag idag', '2023-03-31 09:53:41', NULL),
('svenolof', 14, 'Detta är en kommentar från ett annat konto', '2023-03-31 09:57:28', NULL),
('rolf3000', 15, 'Detta är också en kommentar från ett annat konto', '2023-03-31 10:01:52', NULL),
('lasse', 16, 'gomorrn', '2023-04-14 08:37:12', NULL),
('rolf3000', 17, 'detta är ett svar', '2023-04-19 11:14:45', 16),
('lasse', 18, 'Detta är ett svar!', '2023-04-19 11:33:19', 10),
('lasse', 19, 'Detta är ett väldigt långt svar! Detta är ett väldigt långt svar! Detta är ett väldigt långt svar! Detta är ett väldigt långt svar! Detta är ett väldigt långt svar! Detta är ett väldigt långt svar! Detta är ett väldigt långt svar!', '2023-04-19 11:40:34', 13),
('rolf3000', 20, 'Gomorrn', '2023-04-19 11:42:28', 16),
('lasse', 21, 'Det är fredag idag', '2023-04-21 09:01:57', NULL),
('lasse', 30, 'Hejhej', '2023-04-21 09:33:10', 0),
('lasse', 31, 'Tjena', '2023-04-21 09:33:17', 30),
('lasse', 32, 'Yes det är det', '2023-04-21 09:43:21', 21),
('krister', 52, 'Tjena', '2023-05-15 11:14:32', 0),
('rolf3000', 53, 'haj', '2023-05-15 11:30:08', 52);

-- --------------------------------------------------------

--
-- Tabellstruktur `legosets`
--
...
CREATE TABLE `legosets` (
  ...
  `themeID` varchar(8) DEFAULT NULL,
  `numParts` int(9) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Dumpning av Data i tabell `legosets`
--

INSERT INTO `legosets` (`articleID`, `name`, `year`, `themeID`, `numParts`) VALUES
...
--
-- Dumpning av Data i tabell `simon`
--

INSERT INTO `simon` (`username`, `rounds`) VALUES
('uigisd', 13),
('ioudsfs', 9),
('iuhreu', 9),
('reardsda', 3),
...
('krister', '$2y$10$nfA8nJATNMo/Ve7e4AoVOubth1g0BwwFuvubTIth7Z03T4b4kd/1y'),
('lasse', '$2y$10$a7kII4FkUvNZnjLKZJK7pOYPY1X/o9efxatL8tQCAOqgGvR9cws.a'),
('svenolof', '$2y$10$wXbNB.pA4Jm8VWFraDgQeOT2K2GdxWDS92/ciPUu/yDL28ZpFn7s6'),
('rolf3000', '$2y$10$o5kM3dVc/fAKQOxj59jx8Op9Gbnkvs/eha92aeq8DYdJWIPLr6wdW');
...
--
ALTER TABLE `comments`
  MODIFY `commentID` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=235;
COMMIT;
